...
author:
httpapi : fadcos
short_description: HttpApi Plugin for FortiADC devices
description:
  - This HttpApi plugin provides methods to connect to FortiADC
...
class HttpApi(HttpApiBase):
    ...
    def send_request(self, path, body_params, method_req='POST'):
        ...
        try:
            ...
            logger.debug(str(path) + str(data) + str(response))

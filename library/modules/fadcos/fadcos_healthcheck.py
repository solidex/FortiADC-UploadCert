...
def update(status_code, output, data):
    ...
    if res:
        status_code, output = api.update_obj('api/system_health_check', data, payload)
...
def add_healthcheck(data):
    ...
    data['mkey'] = data['name']
    status_code, output = api.get_obj('api/system_health_check', data)
    ...
    if status_code == 200:
        ...
        # group doesn't exist, identified by name
            ...
            status_code, output = api.add_obj('api/system_health_check', data, payload)

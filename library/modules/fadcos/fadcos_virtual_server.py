...
from ansible.module_utils.network.fadcos.fadcos import fadcos_argument_spec, is_vdom_enable, get_err_msg, list_to_str, list_need_update, is_user_in_vdom
...
def add_vs(module, connection):
    ...
    ips_profile = module.params['ips_profile']
...
def needs_update(module, data):
    ...
    if  module.params['warmup'] and module.params['warmup'] != data['warmup']:
        ...
        res = True
    if  'av_profile' in module.params and module.params['av_profile'] != data['av-profile']:
    ...
    if  list_need_update(module.params['source_pool_list'],  data['schedule-pool-list']):
        data['schedule-pool-list'] = list_to_str(module.params['source_pool_list'])
        res = True
    if  'waf_profile' in module.params and module.params['waf_profile'] != data['waf-profile']:
    ...
    if  module.params['wccp'] and module.params['wccp'] != data['wccp']:
        ...
        res = True
    if  'ips_profile'in module.params and module.params['ips_profile'] != data['ips_profile']:
        data['ips_profile'] = module.params['ips_profile']
        res = True
    if  'dos_profile'in module.params and module.params['dos_profile'] != data['dos_profile']:
...
def main():
    argument_spec = dict(
        ...
        vdom=dict(type='str'),
        ips_profile=dict(type='str', default=''),
        dos_profile=dict(type='str', default='')
    )
